...
enum { EDITBOX_TARGET = 0, EDITBOX_PLAYER, EDITBOX_MINIMAP, EDITBOX_PARTY, EDITBOX_ALLY1, EDITBOX_ALLY2, EDITBOX_WS, EDITBOX_SKILLCHAIN, EDITBOX_TREASURE, EDITBOX_HATE, EDITBOX_POINTWATCH, EDITBOX_GRIMOIRE, EDITBOX_ZONETRACKER, EDITBOX_TIMERS, EDITBOX_TIMERS_R, EDITBOX_EQUIP, EDITBOX_EMPYPOP, EDITBOX_DEBUFFS, EDITBOX_COUNT };
