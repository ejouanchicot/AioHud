...
cl /nologo /EHsc /W4 /WX /permissive- /std:c++17 /Od /wd4456 /DNOMINMAX /D_CRT_SECURE_NO_WARNINGS ^
   ...
   "%ROOT%tests\test_main.cpp" "%ROOT%tests\t_json.cpp" "%ROOT%tests\t_skillchain.cpp" "%ROOT%tests\t_durations.cpp" "%ROOT%tests\t_config.cpp" "%ROOT%tests\t_limbus.cpp" "%ROOT%tests\t_omen.cpp" "%ROOT%tests\t_buffgroups.cpp" "%ROOT%tests\t_songslot.cpp" "%ROOT%tests\t_allygroup.cpp" "%ROOT%tests\t_focusrules.cpp" "%ROOT%tests\t_castmatch.cpp" ^
