...
cl /nologo /MP /EHsc /W4 /WX /permissive- /std:c++17 /Od /Zi /fsanitize=address /wd4456 /DNOMINMAX /D_CRT_SECURE_NO_WARNINGS ^
   ...
   "%ROOT%tests\t_timers.cpp" "%ROOT%tests\t_timersrules.cpp" "%ROOT%tests\t_roster.cpp" "%ROOT%tests\t_battletarget.cpp" "%ROOT%tests\t_treasure.cpp" "%ROOT%tests\t_pointwatch.cpp" "%ROOT%tests\t_packets.cpp" "%ROOT%tests\fake_game.cpp" ^
