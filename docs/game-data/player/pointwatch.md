...
Points for a job = `u16 @ entry+4` (`read_job_spent`, used by the [SCH grimoire](../buffs-and-timers/grimoire-sch.md)).
...
- [SCH grimoire](../buffs-and-timers/grimoire-sch.md) — reuses `read_job_spent` (job_point_info +0x04).
