...
> These offsets share the ActionPacket layout used by the [cast bar](../party/cast-bar.md)
...
## See also
- [Party cast bar — 0x028](../party/cast-bar.md) — the shared ActionPacket bit layout (this module reuses those offsets).
