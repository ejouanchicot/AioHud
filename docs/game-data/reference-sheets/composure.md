...
Voir aussi : `lethargy-armor-set.md` · [Buffs sur les alliés](../buffs-and-timers/buffs-on-allies.md) — l'estimation ally-cast qui applique ce modèle multiplicatif (dont le cas Regen : les secondes flat spécifiques à Regen entrent dans la base via `regen_dur_gear_sec`).