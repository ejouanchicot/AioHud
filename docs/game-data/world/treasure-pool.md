...
[Hate List](../target/hate-list.md) clear).
...
- [Hate List](../target/hate-list.md) — cleared on the same 0x00B zone packet.
- [Party cast bar — 0x028](../party/cast-bar.md) — the sibling packet-parsing module.
