...
- [PointWatch](../player/pointwatch.md) — the same `pwcore.lua` engine (the core XP/CP/ML providers).
- [Party cast bar — 0x028](../party/cast-bar.md) — the packet-bit-read pattern.
